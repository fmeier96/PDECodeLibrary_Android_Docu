...
define('template/helpdesk', ['jquery'], function($){
	...
	var exports = {
		...
		init: function(){
			...
			exports.helpdeskCaller = $('[data-is-helpdesk-caller="true"]').addClass('button dark icon-only icon-help_2');
		},
		...
		exports = {
			...
			initialize: function(options) {
				...
				$.ajax({
					...
					error: function() {
						// XTB-1375
						window.dtag.emit('headerLoadFailure');
					},
					statusCode: {
						404: function() {
		...
		exports = {
			...
			onResponse: function(data) {
				if (data != '') {
					...
					drawerSlider.attach();
					moveSearch.move();
					$('#dtag_search_input').removeClass('large');
